...
import type { User, LoginCredentials, AuthResponse, ErrorResponse } from '@/types/user'
...
export const useAuthStore = defineStore('auth', () => {
  ...
  return { user, isAuthenticated, loading, error, login, logout, fetchSession, clearSession }
})